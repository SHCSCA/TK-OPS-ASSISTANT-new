...
(function () {
    ...
    function _createStub() {
        ...
        return {
            ...
            createVideoSequence: noopObj,
            setActiveVideoSequence: noopObj,
            appendAssetsToSequence: noop,
            addAssetsToTimeline: noop,
            reorderVideoClips: noop,
            trimVideoClip: noopObj,
            removeAssetsFromSequence: noop,
            listVideoClips: noop,
            updateVideoClip: noopObj,
            deleteVideoClip: noopObj,
            listVideoSubtitles: noop,
            createVideoSubtitle: noopObj,
            updateVideoSubtitle: noopObj,
            deleteVideoSubtitle: noopObj,
            createVideoExport: noopObj,
            listVideoExports: noop,
            prepareVideoMonitor: noopObj,
            getVideoMonitorState: noopObj,
            playVideoMonitor: noopObj,
            pauseVideoMonitor: noopObj,
            stopVideoMonitor: noopObj,
            seekVideoMonitor: noopObj,
            stepVideoMonitor: noopObj,
            runVideoExport: noopObj,
            ...
            // Version
            getAppVersion: () => ok({ version: '1.3.0' }),
            checkForUpdate: () => ok({ hasUpdate: false, current: '1.3.0' }),
