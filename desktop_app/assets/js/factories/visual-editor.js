/* ── factories/visual-editor.js ─ 视觉编辑路由工厂 ──
   从 factories/content.js 拆出 visual-editor 专属工厂逻辑。
   ──────────────────────────────────────────────── */
(function () {
    'use strict';

    var VISUAL_EDITOR_CONFIG = {
        eyebrow: '视觉模板工作台',
    ...
    window.makeVisualEditorRoute = function makeVisualEditorRoute() {
